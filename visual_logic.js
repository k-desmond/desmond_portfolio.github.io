...
playSound(loadMedia_HTML5('media\\aesthetic_lofi.mp3'), true);
sound_engine = true;
eventHTMLElem('click', 'volum', true, function(event) {
  if (sound_engine == true) {
    stopSound(loadMedia_HTML5('media\\aesthetic_lofi.mp3'));
    sound_engine = false;
  } else {
    playSound(loadMedia_HTML5('media\\aesthetic_lofi.mp3'), true);
    sound_engine = true;
